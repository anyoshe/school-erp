  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50/50 via-slate-50 to-indigo-50/30 p-6 md:p-10">
      <div className="max-w-6xl mx-auto">
        {/* Header */}
        <div className="mb-10">
          <h1 className="text-4xl font-bold text-slate-900">Procurement & Supply Chain</h1>
          <p className="text-lg text-slate-600 mt-3">
            Manage vendors, tenders, purchase orders, and school supplies
          </p>
        </div>
        ...
        <Card className="bg-white/70 backdrop-blur-xl border border-white/30 rounded-3xl shadow-2xl overflow-hidden">
          ...
          <CardContent className="p-8 text-center space-y-6">
            ...
            <p className="text-slate-600 max-w-2xl mx-auto">
              This essential procurement feature is coming soon.
              You'll be able to manage vendors, create tenders, issue purchase orders, and ensure transparent spending.
            </p>
